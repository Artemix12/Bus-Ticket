      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-500">
              A modern platform to search, book, and manage bus tickets — fast,
        ...
        <div className="flex flex-col items-center justify-between gap-3 border-t border-white/[0.06] py-6 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            {/* X / Twitter */}
            <Link href="#" aria-label="Twitter" className="text-slate-600 transition hover:text-white">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </Link>
            {/* GitHub */}
            <Link href="#" aria-label="GitHub" className="text-slate-600 transition hover:text-white">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
            ...
            {/* LinkedIn */}
            <Link href="#" aria-label="LinkedIn" className="text-slate-600 transition hover:text-white">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
